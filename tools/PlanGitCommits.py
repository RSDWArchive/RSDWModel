...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plan RSDWModel git commit batches.")
    ...
    parser.add_argument("--message-prefix", default="Update RSDWModel data")
    ...
    parser.add_argument(
        "--deletions-first",
        action="store_true",
        help="Put delete-only changes first. RSDWModel defaults to deletions last.",
    )
